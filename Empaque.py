...
peso_minimo = st.number_input("Peso mínimo por unidad (kg):", min_value=0.0, value=0.5, format="%.2f")
peso_maximo = st.number_input("Peso máximo por unidad (kg):", min_value=0.0, value=1.5, format="%.2f")
peso_configurar = st.number_input("Peso a configurar en la máquina (kg):", min_value=0.0, value=1.0, format="%.2f")
